"""Error message sanitizer for Omni MCP Server.
...
class ErrorSanitizer:
    ...
    PATTERNS_TO_REMOVE = [
        ...
        (r'^\s*File "[^"]+", line \d+.*$', ""),
        # Module paths
        (r"mcp_server_omni\.[a-zA-Z_\.]+:", ""),
        (r"omni\.[a-zA-Z_\.]+:", ""),
        # Class names
        (r"<class \'[^\']+\'>", ""),
        (r"MCPObjectController:", ""),
        (r"OmniConnectionError:", ""),
    ...
    ERROR_MAPPINGS = {
        ...
        r"Connection refused": "Cannot connect to Omni server",
    ...
    def _map_error_type(cls, error_type: str) -> str:
        ...
        mappings = {
            ...
            "OmniConnectionError": "connection_error",
    ...
    def sanitize_xmlrpc_fault(cls, fault_string: str) -> str:
        """Sanitize XML-RPC fault messages from Omni.
