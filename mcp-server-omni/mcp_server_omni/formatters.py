...
This module provides formatters that convert Omni data into
...
class RecordFormatter:
    """Formats Omni records for LLM consumption.

    This class converts complex Omni data structures into hierarchical
    ...
    def _format_field_value(
        ...
        # Date/time fields
            ...
            if isinstance(value, str):
                # Handle Omni's datetime format (YYYYMMDDTHH:MM:SS)
                if (
                    field_type == "datetime"
                    and len(value) == 17
                    and "T" in value
                    ...
                    try:
                        # Parse Omni's compact datetime format
                ...
                # Handle standard datetime formats
                    ...
                    try:
                        # Parse standard Omni datetime format
