...
class MCPTestClient:
    ...
    def __init__(self, server_command: Optional[List[str]] = None):
        ...
        Args:
            server_command: Command to start the server.
                           Defaults to ["uvx", "mcp-server-omni"]
        """
        # Use python module directly since package isn't published
        self.server_command = server_command or [sys.executable, "-m", "mcp_server_omni"]
    ...
    async def read_resource(self, uri: str) -> str:
        ...
        Args:
            uri: Resource URI (e.g., "omni://res.partner/record/1")
...
if __name__ == "__main__":
    ...
    async def main():
        ...
        required_vars = ["OMNI_URL", "OMNI_API_KEY"]
