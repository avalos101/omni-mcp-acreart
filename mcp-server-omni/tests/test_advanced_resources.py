...
class TestAdvancedResourceIntegration:
    """Integration tests for advanced resources with real Omni."""

    @pytest.mark.asyncio
    @pytest.mark.integration
    @skip_on_rate_limit
    async def test_browse_real_records(self, real_config, real_connection):
        """Test browse with real Omni connection."""
    ...
    async def test_count_real_records(self, real_config, real_connection):
        """Test count with real Omni connection."""
        # Setup real components
        app = Mock(spec=FastMCP)
        app.resource = Mock()
        app._handlers = {}
    ...
    async def test_fields_real_model(self, real_config, real_connection):
        """Test fields with real Omni model."""
        # Setup real components
        app = Mock(spec=FastMCP)
        app.resource = Mock()
        app._handlers = {}
