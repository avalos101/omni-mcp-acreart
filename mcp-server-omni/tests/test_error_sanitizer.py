...
class TestErrorSanitizer:
    ...
    def test_sanitize_file_paths(self):
        ...
        message = 'File "/home/user/omni/models.py", line 123, in execute'
    ...
    def test_sanitize_module_paths(self):
        ...
        message = "mcp_server_omni.omni_connection: Connection failed"
        sanitized = ErrorSanitizer.sanitize_message(message)
        assert "mcp_server_omni." not in sanitized
    ...
    def test_connection_error_mapping(self):
        ...
        sanitized = ErrorSanitizer.sanitize_message(message)
        assert sanitized == "Cannot connect to Omni server"
    ...
    def test_error_type_mapping(self):
        ...
        assert ErrorSanitizer._map_error_type("OmniConnectionError") == "connection_error"
    ...
    def test_complex_error_message(self):
        ...
        File "/opt/omni/addons/mcp_server/controllers/xmlrpc.py", line 123"""
