...
def fastmcp_app():
    ...
    return FastMCP(name="test-omni-mcp")
...
def resource_handler(fastmcp_app, mock_connection, mock_access_controller, mock_config):
    ...
    return OmniResourceHandler(fastmcp_app, mock_connection, mock_access_controller, mock_config)
...
class TestResourceRegistration:
    ...
    def test_search_resources_registered(self, resource_handler, fastmcp_app):
        ...
        # - omni://{model}/search (no parameters)
        # - omni://{model}/record/{record_id}
        # - omni://{model}/count (no parameters)
        # - omni://{model}/fields
