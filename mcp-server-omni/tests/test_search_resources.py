...
def real_connection(real_config):
    """Create a real Omni connection."""
    return OmniConnection(real_config)
...
class TestSearchResourceIntegration:
    """Integration tests for search resource with real Omni."""

    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_search_real_partners(self, real_config, real_connection):
        """Test search with real Omni connection."""
        ...
        handler = OmniResourceHandler(app, real_connection, access_controller, real_config)
