...
from mcp_server_omni.access_control import AccessControlError, AccessController
from mcp_server_omni.config import OmniConfig
from mcp_server_omni.error_handling import (
    ValidationError,
)
from mcp_server_omni.omni_connection import OmniConnection, OmniConnectionError
from mcp_server_omni.tools import OmniToolHandler, register_tools


class TestOmniToolHandler:
    """Test cases for OmniToolHandler class."""
    ...
    def mock_connection(self):
        """Create a mock OmniConnection."""
        connection = MagicMock(spec=OmniConnection)
    ...
    def handler(self, mock_app, mock_connection, mock_access_controller, valid_config):
        """Create an OmniToolHandler instance."""
        return OmniToolHandler(mock_app, mock_connection, mock_access_controller, valid_config)
    ...
    async def test_search_records_connection_error(
        ...
        # Setup mocks
        mock_connection.search_count.side_effect = OmniConnectionError("Connection lost")
    ...
    async def test_search_records_with_domain_operators(
        ...
        """Test search_records with Omni domain operators like |, &, !."""
        # Setup mocks
        mock_access_controller.validate_model_access.return_value = None
    ...
    async def test_get_record_connection_error(
        ...
        # Setup mocks
        mock_connection.read.side_effect = OmniConnectionError("Connection lost")
    ...
    async def test_list_models_success(
        ...
        from mcp_server_omni.access_control import ModelPermissions
    ...
    async def test_list_models_with_permission_failures(
        ...
        # Setup mocks for get_model_permissions
        from mcp_server_omni.access_control import AccessControlError, ModelPermissions
...
class TestRegisterTools:
    ...
    def test_register_tools_success(self):
        ...
        mock_connection = MagicMock(spec=OmniConnection)
        ...
        assert isinstance(handler, OmniToolHandler)
        assert handler.app == mock_app
...
class TestToolIntegration:
    ...
    async def test_search_tool_with_real_server(self):
        ...
        # This test would require a running Omni instance
        # Skipping for unit tests
        pytest.skip("Integration test requires running Omni instance")
