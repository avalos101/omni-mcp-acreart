...
correctly with the Omni MCP server in integration with pytest.
"""
...
class TestTransportIntegration:
    ...
    @pytest.mark.asyncio
    async def test_stdio_transport_basic_flow(self, omni_server_required):
    ...
    @pytest.mark.asyncio
    async def test_stdio_transport_multiple_requests(self, omni_server_required):
    ...
    @pytest.mark.asyncio
    async def test_http_transport_basic_flow(self, omni_server_required):
    ...
    @pytest.mark.asyncio
    async def test_http_transport_session_persistence(self, omni_server_required):
    ...
    @pytest.mark.asyncio
    async def test_http_transport_tool_call(self, omni_server_required):
...
class TestTransportCompatibility:
    ...
    @pytest.mark.asyncio
    async def test_server_version_consistency(self, omni_server_required):
