...
from mcp_server_omni.tools import OmniToolHandler, ToolError, register_tools
...
class TestWriteTools:
    ...
    def tool_handler(self, mock_app, mock_connection, mock_access_controller, mock_config):
        """Create OmniToolHandler instance."""
        return OmniToolHandler(mock_app, mock_connection, mock_access_controller, mock_config)
    ...
    async def test_update_record_connection_error(self, tool_handler, mock_connection):
        ...
        mock_connection.read.side_effect = OmniConnectionError("Connection failed")
...
class TestWriteToolsIntegration:
    ...
    def real_config(self):
        ...
        from mcp_server_omni.config import load_config
    ...
    def real_connection(self, real_config):
        ...
        conn = OmniConnection(real_config)
        conn.connect()
        conn.authenticate()
        yield conn
        conn.disconnect()
    ...
    def real_access_controller(self, real_config):
        ...
        from mcp_server_omni.access_control import AccessController
    ...
    async def test_create_update_delete_cycle(self, real_tool_handler):
        """Test full create, update, delete cycle with real Omni."""
        ...
        try:
            ...
            # Verify deletion
            from mcp_server_omni.tools import ToolError
